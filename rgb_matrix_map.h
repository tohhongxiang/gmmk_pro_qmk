#ifndef RGB_MATRIX_MAP_H
#define RGB_MATRIX_MAP_H
    ...
    const uint8_t LED_SIDE_LEFT[] = { LED_L8, LED_L7, LED_L6, LED_L5, LED_L4, LED_L3, LED_L2, LED_L1};

    const uint8_t LED_SIDE_RIGHT[] = { LED_R8, LED_R7, LED_R6, LED_R5, LED_R4, LED_R3, LED_R2, LED_R1};
